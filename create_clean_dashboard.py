#!/usr/bin/env python3
"""
Create Clean Enhanced Dashboard
Create a clean enhanced dashboard without encoding issues
"""
...
def create_clean_enhanced_dashboard():
    """Create a clean enhanced dashboard"""
    print("🔄 CREATING CLEAN ENHANCED DASHBOARD")
    print("=" * 50)
    
    # Create the enhanced dashboard content
...
'''
    ...
    enhanced_app_path = dashboard_dir / "enhanced_app.py"
    with open(enhanced_app_path, 'w', encoding='utf-8') as f:
        f.write(enhanced_app_content)
    
    print(f"✅ Created clean enhanced dashboard: {enhanced_app_path}")
    return enhanced_app_path

def main():
    """Main creation function"""
    created_path = create_clean_enhanced_dashboard()
    
    print("\n✅ Clean enhanced dashboard created!")
    print(f"📁 Location: {created_path}")
    print("\n🚀 To launch:")
    print("   streamlit run dashboard/enhanced_app.py")
